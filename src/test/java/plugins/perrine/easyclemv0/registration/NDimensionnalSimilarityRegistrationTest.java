...
class NDimensionnalSimilarityRegistrationTest {
    ...
    void complexRotation() {
        ...
        List<Point> targetPoints = new ArrayList<>();
        targetPoints.add(new Point(new Matrix(new double[][] {{ 2 }, { -1.4142136 }, { 1.110223e-16 }})));
        targetPoints.add(new Point(new Matrix(new double[][] {{ 2 }, { -0.7071068 }, { 2.121320 }})));
        targetPoints.add(new Point(new Matrix(new double[][] {{ -2 }, { -2.1213203 }, { 2.121320 }})));
        Dataset target = new Dataset(targetPoints);
