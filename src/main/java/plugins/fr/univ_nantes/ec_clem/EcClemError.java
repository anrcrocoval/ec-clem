...
import plugins.fr.univ_nantes.ec_clem.error.fitzpatrick.TargetRegistrationErrorMapFactory;
import plugins.fr.univ_nantes.ec_clem.error.fitzpatrick.TargetRegistrationErrorMapSupplier;
